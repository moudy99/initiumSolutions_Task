    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1191 Nile Corniche, Cairo, Egypt", "Conrad Cairo" },
                    { 2, "Nile City Towers ", "Fairmont Nile City" },
                    { 3, "12 Ahmed Ragheb St, Cairo, Egypt", "Kempinski Nile Hotel Cairo" },
                    { 4, " Garden City, Cairo, Egypt", "InterContinental Cairo Semiramis" },
                    { 5, " , Cairo, Egypt", "Four Seasons Hotel " },
                    { 6, "1115 , Cairo, Egypt", "Ramses Hilton" }
                });
